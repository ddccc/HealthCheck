...
public class Implication extends Formula {
    ...
    public Formula getCondition() { return (Formula) args.elementAt(0); }
    public Formula getConclusion() { return (Formula) args.elementAt(1); }
	...
	return new Implication(newArgs);
    }
