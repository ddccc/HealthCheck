...
public class AskMembers extends HttpServlet {
	...
	for (int i = 0; i < lng; i++) {
	    String locName2 = (String) members.elementAt(i);
...
"       </field> \n" +
"    <block> \n" +
"       An error happend in Ask Members.  This sentence is not supposed to be reachable!! \n" +
