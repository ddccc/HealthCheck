...
public class AskBodyPart extends HttpServlet {
	...
	if ( null == session ) {	
	    PhoneError.call(res, "bevocal", 
			    // "Your session expired while in Ask Body Part."
			    L.AskBodyPart0
			    );
	    return;
	}
	Hashtable unboundHashtable = (Hashtable) session.getValue("unboundHashtable");
	String page = "phone.AskBodyPart";
...
//"		OK, which part of your: " + printName + " if any, hinders you the most? \n" +
	        L.AskBodyPart1 +  printName + L.AskBodyPart2 +
...
"       </field> \n" +
"    <block> \n" +
//"       An error happend in Ask Body Part.  This sentence is not supposed to be reachable!! \n" +
	  L.AskBodyPart6 +
