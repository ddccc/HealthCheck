...
public class ShowSymptomsDetails extends HttpServlet {
	...
	throws ServletException, IOException
    {
      ...
      out.println("<html>");
      out.println("<head><title>All Symptoms Details</title></head>");
	...
	out.println(
	     ...
	     " </td><td> " +
	     "<a href='" + D.servletShowSymptomDetails + "?sym=" + dis + 
	                   "'> ShowSymptomDetails </a></td><tr>");
      }
      out.println("</table>");
      out.println("</body>");
      out.println("</html>");
