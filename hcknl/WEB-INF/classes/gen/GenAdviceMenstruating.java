...
public class GenAdviceMenstruating   {
...
"<h2> $$" +
"<font size=\"4\"> $$" +
	// "ADVICE: Since your menopause appears to be late, please make an $$" +
L.AdviceMenstruatingS1 + " $$" +
	// "appointment with your physician. $$" +
L.AdviceMenstruatingS2 + " $$" +
"</font> $$" +
"</h2> $$" +
" $$" +
...
"</html> $$";
    ...
    String name = "AdviceMenstruating";
...
} // end class GenAdviceMenstruating
