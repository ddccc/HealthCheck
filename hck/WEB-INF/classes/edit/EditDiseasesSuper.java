...
public class EditDiseasesSuper extends HttpServlet {
	...
	throws ServletException, IOException
    {
      ...
      out.println("<HTML>");
      out.println("<HEAD><TITLE>All DiseasesSuper</TITLE></HEAD>");
      out.println("<BODY BGCOLOR=lightgreen>");
      out.println("<H1>Select Super Disease </H1>");
	...
	illustrations = disease.getIllustrations();
	cnt++;
	...
	out.println(
	     ...
	     "<A HREF='" + D.servletShowDisease + "?dis=" + dis + "'> show </A></td><td>" +
	     illustrations.size() +
	     "</td></tr>");
      }
	...
	out.println(
      ...
      */
      out.println("</table>");
      out.println("<p># super diseases: " + cnt);
      out.println("</BODY>");
      out.println("</HTML>");
    }
}
