...
public class SetupPH extends HttpServlet {
	...
	props.putProperty("phName",firstName+"_"+lastName);
	props.putProperty("phone",phone);
	props.putProperty("email",email);
	...
	out.println("<h3>Info was saved!!</h3>");
