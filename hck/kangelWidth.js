...
// Assume that the callcenter has a KClient servlet that takes as
// arguments: page and counter
...
function checkImage() {
      ...
      document.images['contact'].src =	
            "/hck/servlet/patient.KClient?page=" + page + "&counter=" + cnt;
      setTimeout("checkImage()", heartBeatInterval);
}

document.writeln(
    "<img src='/hck/servlet/patient.KClient?page=" + page + "&counter=0' " + 
