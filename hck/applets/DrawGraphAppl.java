...
public class DrawGraphAppl extends java.applet.Applet {
    int width, height;
  ...
  public void init() {
	...
	minX = Integer.parseInt(minXSt);
	maxX = Integer.parseInt(maxXSt);
  ...
  public void paint( java.awt.Graphics gc ) {
    ...
    gc.drawString(rightBottomSt, right-10*rightBottomSt.length(), bottom+10);
    String yBot = ""+minY;
